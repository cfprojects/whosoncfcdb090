...
<cffunction name="getDescription" returntype="string" hint="I write the description text" >
    ...
    <cftry>
	<cfset qHistory=application.whoson.getHistory(arguments.clientid) />
	
	<cfif qHistory.RecordCount>
	<cfoutput>
		<cfsavecontent variable="hist">
		<p>PageHistory available: #qHistory.RecordCount# page(s).</p>
		<table style="width:100%" cellpadding="0" cellpadding="0" border="0">
			<tr>
			...
			<tr>
				<td>#Page#</td>
				<td>#TimeFormat(LoadTime,"h:mm:ss tt")#</td>
			</tr>				
			</cfloop>						
		</table>
		<br />
